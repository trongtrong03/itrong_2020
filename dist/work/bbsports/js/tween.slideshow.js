...
(function ($) {
    ...
    $.fn.slideshow = function (options) {
        ...
        main = {
            ...
            //開啟導覽列
            setNav: function () {
                $this.append('<div id="js-ele-slideshow-control-wrap' + settings.uni + '" class="ele-slideshow-control-wrap"></div>');
                var $control = $this.find('#js-ele-slideshow-control-wrap' + settings.uni + ''),
                    _nav = [],
                    html = '',
                    i, active;
